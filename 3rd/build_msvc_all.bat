...
devenv cd\mak.vc12\cd.sln /Build Debug /project cd\mak.vc12\cd.vcxproj /projectconfig "Debug|x64" /project cd\mak.vc12\cdlua.vcxproj /projectconfig "Debug|x64"
