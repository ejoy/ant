...
void CUSTOM_FS(in Varyings varyings, out FSOutput fsoutput)
{
    ...
    material_info mi = terrain_material_info_init(varyings.normal, stone_normal, varyings.pos, vec4(terrain_color, 1.0), varyings.frag_coord, u_metallic_factor, u_roughness_factor);
