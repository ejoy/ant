...
const char * attrib_arena_init_buffer(struct attrib_arena *A, int id, uint32_t handle, uint8_t stage, bgfx_access_t access, uint8_t mip);
...
attrib_id attrib_arena_clone(struct attrib_arena *A, attrib_id prev, attrib_id node);
