...
function testcube.init(window_handle, width, height, app_dir, bundle_path)
    ...
    local vs_path = app_dir .. "/Assets/shaders/essl/vs_cubes"
    local fs_path = app_dir .. "/Assets/shaders/essl/fs_cubes"
