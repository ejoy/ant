...
local function create_ring_entity(world,color,size,rot,name,parent,dir)
    ...
    local eid = world:create_entity {
        ...
        data = {
            ...
            material = world.component "material" "/pkg/ant.resources/materials/gizmo_front_singlecolor.material",
...
local function create_line_entity(world, name, start_pos,end_pos,color,parent,dir)
    ...
    return world:create_entity {
        ...
        data = {
            transform = {},
            material = world.component "material" "/pkg/ant.resources/materials/gizmo_line.material",
            name = name,
            state = ies.create_state "visible|selectable",
            gizmo_object = {dir = dir},
            scene_entity = true,
...
local function create_circle_entity(world, name,color,rot,parent,dir)
    ...
    return world:create_entity {
        ...
        data = {
            ...
            material = world.component "material" "/pkg/ant.resources/materials/gizmo_front_line.material",
            name = name,
            state = ies.create_state "visible|selectable",
            gizmo_object = {dir = dir},
            scene_entity = true,
...
local function create_cone_entity(world, color, size,rot,pos, name,parent,dir)
    ...
    local eid = world:create_entity {
        ...
        data = {
            ...
            material = world.component "material" "/pkg/ant.resources/materials/gizmo_singlecolor.material",
            state = ies.create_state "visible|selectable",
            name = name,
            gizmo_object = {dir=dir},
            scene_entity = true,
