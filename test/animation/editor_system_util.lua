...
local function create_ring_entity(world,color,size,rot,name,parent,dir)
    ...
    local eid = world:create_entity {
        ...
        data = {
            ...
            mesh = "/pkg/ant.resources.binary/meshes/base/ring.glb|meshes/mesh1_P1.meshbin",
            material = "/pkg/ant.resources/materials/gizmo_front_singlecolor.material",
...
local function create_cone_entity(world, color, size,rot,pos, name,parent,dir)
    ...
    local eid = world:create_entity {
        ...
        data = {
            ...
            material = "/pkg/ant.resources/materials/gizmo_singlecolor.material",
            state = ies.create_state "visible|selectable",
            name = name,
            gizmo_object = {dir=dir},
            scene_entity = true,
