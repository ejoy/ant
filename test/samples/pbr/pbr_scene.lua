...
function pbr_scene.create_scene(world)
    create_pbr_entity( world, "cerbernus",
                       ...
                       {0,0,0},
                       {1,1,1},
                      "/pkg/pbr/assets/mesh/sphere.mesh",
                      "/pkg/pbr/assets/material/Cerberus_LP.material"
                    )
    ...
    --                     rotation,
    --                     {0.3,0.3,0.3},
    --                    "/pkg/pbr/assets/mesh_desc/Cerberus_LP.mesh",
    --                    "/pkg/pbr/assets/material/Cerberus_LP.material"
    --              )
    ...
    for i = 0, 4 do 
        for j = 0, 4 do                                 
                ...
                create_pbr_entity(  world, "gold", 
                                ...
                                {3.,3.,3.},
                                "/pkg/pbr/assets/mesh/sphere.mesh",
                                "/pkg/pbr/assets/material/gold.material",
                                metal, rough )
        end 
    end   
    ...
    for i = 0, 4 do 
        for j = 0, 4 do                                 
                ...
                create_pbr_entity(  world, "plastic", 
                                ...
                                {3.,3.,3.},
                                "/pkg/pbr/assets/mesh/sphere.mesh",
                                "/pkg/pbr/assets/material/plastic.material",
                                metal, rough )
        end 
    end     
    end
