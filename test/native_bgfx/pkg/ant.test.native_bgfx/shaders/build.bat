...
%wdir%\bin\msvc\Debug\shaderc.exe --platform windows --type fragment -p spirv --raw -f mesh\fs_mesh_raw.sc -o %windowvkdir%\fs_mesh_raw.bin --depends -i %shaderinc% --debug
%wdir%\bin\msvc\Debug\shaderc.exe --platform windows --type vertex -p spirv --raw -f mesh\vs_mesh_raw.sc -o %windowvkdir%\vs_mesh_raw.bin --depends -i %shaderinc% --debug
...
%wdir%\bin\msvc\Debug\shaderc.exe --platform windows --type fragment -p spirv --raw -f mesh\fs_mesh_raw.sc -o %androidvkdir%\fs_mesh_raw.bin --depends -i %shaderinc% --debug
%wdir%\bin\msvc\Debug\shaderc.exe --platform windows --type vertex -p spirv --raw -f mesh\vs_mesh_raw.sc -o %androidvkdir%\vs_mesh_raw.bin --depends -i %shaderinc% --debug
