        ...
        for fbx_uuid, fbx_item in fbx_table_nodes.items():
            ...
            for (fbx_lnk,
                ...
                if fbx_lnk_type.props[0] == b'OP':
                    ...
                    if lnk_type in {b'DiffuseColor', b'3dsMax|maps|texmap_diffuse', b'Maya|baseColor'}:
                        ma_wrap.base_color_texture.image = image
                        texture_mapping_set(fbx_lnk, ma_wrap.base_color_texture)
                    elif lnk_type in {b'SpecularColor', b'SpecularFactor', b'Maya|specularRoughness'}:
                        # Intensity actually, not color...
                        ma_wrap.specular_texture.image = image
                        texture_mapping_set(fbx_lnk, ma_wrap.specular_texture)
                    elif lnk_type in {b'ReflectionColor', b'ReflectionFactor', b'3dsMax|maps|texmap_reflection', b'Maya|metalness'}:
                        # Intensity actually, not color...
                    ...
                    elif lnk_type in {b'NormalMap', b'Bump', b'3dsMax|maps|texmap_bump', b'Maya|normalCamera'}:
