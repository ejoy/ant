...
bool RealTimeBullet3CollisionSdk::raycast( plCollisionWorldHandle worldHandle, plVector3 rayFrom, plVector3 rayTo,
							   ClosestRayResult &result)
{
	// todo: raycast and  convert result from bullet to interface 
	return true;
}
