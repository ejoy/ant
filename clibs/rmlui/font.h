...
public:
	...
	int GenerateString(Rml::FontFaceHandle handle, Rml::TextEffectsHandle text_effects_handle, const std::string& string, const Rml::Point& position, const Rml::Color& colour, Rml::GeometryList& geometrys);
	virtual void GenerateString(Rml::FontFaceHandle face_handle, Rml::TextEffectsHandle text_effects_handle, Rml::LineList& lines, const Rml::Color& colour, Rml::GeometryList& geometry)override;
