...
SAMPLERCUBE(s_prefilter, 5);
SAMPLER2D(s_LUT, 6);

uniform vec4 u_pbr_ibl_param;
#define u_prefilter_cube_mip_levels	u_pbr_ibl_param.x
#define u_scaleIBLAmbient			u_pbr_ibl_param.y
...
void main()
{
	...
	color += calc_indirect_lighting_IBL(pbr_inputs, N, R, basecolor.rgb, F0);
