...
//     vec3 c;
//     c  = texture2DLod(s_scene_color, uv + d.zw, lod).rgb;
//     c += texture2DLod(s_scene_color, uv + d.xw, lod).rgb;
//     c += texture2DLod(s_scene_color, uv + d.xy, lod).rgb;
//     c += texture2DLod(s_scene_color, uv + d.zy, lod).rgb;
